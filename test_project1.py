...
class TestProject1(unittest.TestCase):
    def setUp(self):
        self.rows = [
            {"Region": "East", "Sub-Category": "Chairs", "Sales": 200.0, "Profit": 20.0, "Quantity": 4, "Discount": 0.1, "State": "New York", "Segment": "Consumer", "Category": "Furniture"},
            {"Region": "East", "Sub-Category": "Chairs", "Sales": 0.0, "Profit": 0.0, "Quantity": 2, "Discount": 0.0, "State": "New York", "Segment": "Consumer", "Category": "Furniture"},
            {"Region": "West", "Sub-Category": "Tables", "Sales": 300.0, "Profit": -30.0, "Quantity": 3, "Discount": 0.25, "State": "California", "Segment": "Corporate", "Category": "Furniture"},
            {"Region": "West", "Sub-Category": "Tables", "Sales": 200.0, "Profit": 10.0, "Quantity": 1, "Discount": 0.5, "State": "California", "Segment": "Corporate", "Category": "Furniture"},
            {"Region": "South", "Sub-Category": "Paper", "Sales": 100.0, "Profit": 50.0, "Quantity": 10, "Discount": 0.0, "State": "Texas", "Segment": "Home Office", "Category": "Office Supplies"},
            {"Region": "South", "Sub-Category": "Paper", "Sales": 100.0, "Profit": -50.0, "Quantity": 10, "Discount": 0.2, "State": "Texas", "Segment": "Home Office", "Category": "Office Supplies"},
        ]

    # margin_by_region_subcategory: 2 normal, 2 edge
    def test_margin_normal(self):
        result = margin_by_region_subcategory(self.rows)
        east_chairs = next(r for r in result if r["Region"] == "East" and r["SubCategory"] == "Chairs")
    ...
    def test_margin_zero_sales_guard(self):
        ...
        rows = [
            {"Region": "X", "Sub-Category": "Y", "Sales": 0.0, "Profit": 10.0, "Quantity": 1, "Discount": 0.0}
        ]
    ...
    def test_margin_multiple_groups(self):
        result = margin_by_region_subcategory(self.rows)
        west_tables = next(r for r in result if r["Region"] == "West" and r["SubCategory"] == "Tables")
    ...
    def test_margin_missing_labels(self):
        rows = [{"Region": "East", "Sales": 100.0, "Profit": 10.0}]  # missing Sub-Category
        result = margin_by_region_subcategory(rows)
    ...
    def test_loss_pct_filters_high_discount(self):
        ...
        ca_corp = next(r for r in result if r["State"] == "California" and r["Segment"] == "Corporate")
        # two lines, one loss
    ...
    def test_aov_basic(self):
        ...
        east_consumer = next(r for r in result if r["Region"] == "East" and r["Segment"] == "Consumer")
    ...
    def test_aov_multiple_groups(self):
        result = avg_order_value_by_region_segment(self.rows)
        south_home = next(r for r in result if r["Region"] == "South" and r["Segment"] == "Home Office")
    ...
    def test_discount_tiers_and_averages(self):
        ...
        medium_office = next(r for r in result if r["discount_tier"] == "Medium" and r["Category"] == "Office Supplies")
